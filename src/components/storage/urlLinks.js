...
export const LIST_URL = `${process.env.REACT_APP_API_URL}/movies?limit=5`;
export const SortLIST_URL = `${process.env.REACT_APP_API_URL}/movies?sort=title&order=DESC&limit=5`;